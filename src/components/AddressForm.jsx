...
export default function AddressForm({ handleAddressButton }) {
  ...
  return (
    <div className="w-1/2 rounded-xl border bg-neutral-100 p-10 shadow-lg max-lg:w-3/4 max-md:w-[90%]">
      <button
        type="button"
      ...
      <h1 className="text-2xl text-neutral-700">Enter address details :</h1>
      <div className="mt-10 grid grid-cols-1 gap-4 space-y-6">
        <div>
          <label
            htmlFor="street"
