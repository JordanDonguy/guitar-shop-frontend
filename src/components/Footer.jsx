...
export default function Footer() {
  return (
    <footer className="bg-neutral-800 text-teal-50">
      <div className="flex items-center justify-between px-[10%] max-2xl:px-[5%] max-lg:flex-col max-lg:h-auto">
        <nav aria-label="Social media" className="flex w-120 flex-wrap items-center justify-between max-lg:w-full max-lg:py-10">
          <a
        ...
        <div className="ml-15 flex w-3/5 justify-between py-10 max-lg:ml-0 max-lg:w-full">
          <section className="mr-20 flex h-64 flex-col justify-between" aria-labelledby="features-title">
            <h3 id="features-title" className="mb-4 text-5xl">Features</h3>
          ...
          <section className="flex h-64 flex-col justify-between pr-[10%]" aria-labelledby="company-title">
            <h3 id="company-title" className="mb-4 text-5xl">Company</h3>
