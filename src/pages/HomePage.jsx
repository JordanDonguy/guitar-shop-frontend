...
export default function HomePage() {
    ...
    return (
        <div class="flex flex-col items-center w-full pt-[100px] font-onest">

            {/* Hero Section */}

            <div class={`${isVisible ? 'fade-in' : ''} flex h-[calc(100vh-100px)] shadow-lg`}>
                <div class="flex flex-col justify-between pt-5 pb-10 pl-[10%]">
                    <h1 class="text-8xl/30 text-shadow-lg">Find the guitar you’ve always wanted</h1>
                    <p class="w-170 text-4xl/15 font-light  text-shadow-lg">Explore our selection of electric and acoustic guitars, amps, effects and all the accessories and home-studio gear that you’re dreaming of !</p>
                ...
                <div class="flex justify-center items-center bg-neutral-200 w-[80%] pr-[10%]"><img src={guitar} alt="guitar" class="h-full py-10" style={{ filter: 'drop-shadow(30px 20px 5px rgba(139, 143, 143, 0.5))' }} /></div>
            </div>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex justify-center text-shadow-lg">
                    {/* Product card */}
                    <div class="flex flex-col items-center justify-between h-160 w-140 border-r-2 border-teal-200">
                        <img src={eGuitar} class="w-110" style={{ filter: 'drop-shadow(10px 10px 10px rgba(0, 0, 0, 0.5))' }} />
                        <div class="flex flex-col items-center justify-between h-[30%] pt-5">
                            <h3 class="text-3xl font-medium">PRS</h3>
                            <h4 class="text-2xl text-center w-[60%]">John Mayer Silver Sky Electric Guitar Tungsten</h4>
                            <span class="text-3xl font-bold">$ 2749</span>
                        </div>
                    </div>
                    {/* Product card */}
                    <div class="flex flex-col items-center justify-between h-160 w-140 border-r-2 border-teal-200">
                        <img src={amp} class="w-100 pt-5 pb-5" style={{ filter: 'drop-shadow(10px 10px 10px rgba(0, 0, 0, 0.5))' }} />
                        <div class="flex flex-col items-center justify-between h-[30%] pt-5">
                            <h3 class="text-3xl font-medium">Tone King</h3>
                            <h4 class="text-2xl text-center w-[60%]">Imperial MKII 20W 1x12 Tube Guitar Combo Amp</h4>
                            <span class="text-3xl font-bold">$ 2695</span>
                        </div>
                    </div>
                    {/* Product card */}
                    <div class="flex flex-col items-center justify-between h-160 w-140">
                        <img src={aGuitar} class="w-110" style={{ filter: 'drop-shadow(10px 10px 10px rgba(0, 0, 0, 0.5))' }} />
                        <div class="flex flex-col items-center justify-between h-[30%] pt-5">
                            <h3 class="text-3xl font-medium">Martin</h3>
                            <h4 class="text-2xl text-center w-[60%]">Special D Classic Dreadnought Acoustic</h4>
                            <span class="text-3xl font-bold">$ 889</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="text-center text-2xl w-[75%] py-8">
                    ⭐️⭐️⭐️⭐️⭐️<br></br>
            ...
            {/* Newsletter Section */}
            <div class="flex flex-col items-center w-full px-[10%] bg-neutral-200 pb-30">
