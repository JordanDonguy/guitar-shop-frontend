...
export default function About() {
  return (
    <section className="fade-in mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-between px-4 pt-30 pb-10 max-2xl:pb-5 max-xl:items-start max-lg:pt-55">
      <Helmet>
      ...
      <p className="mb-2 text-center text-xl font-semibold max-xl:text-left">
        Welcome to Guitar Shop! We’re passionate about bringing quality
        instruments to musicians of all levels.
      </p>

      <p className="mb-2 text-center text-lg max-xl:text-left">
