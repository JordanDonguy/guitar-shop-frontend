...
export default function SingleProduct() {
  ...
  return (
    <div className="mb-20 bg-gray-100 px-[10%] pt-[140px] max-2xl:px-[5%]">
      <Helmet>
        <title>{`${productInfos.name}`} | Guitar Shop</title>
      </Helmet>
      {/* SECTION 1 */}
      <div className="mb-10 flex rounded-xl shadow-lg">
        <div className="inline-flex w-full justify-center rounded-xl bg-teal-50">
          <img
            src={productInfos.image_url2}
            alt={productInfos.name}
            className="max-h-[75vh] w-[65%] rounded-l-xl bg-white object-contain px-[2%]"
          />

          <div className="w-[30%] flex-1 border-l border-teal-200 pt-15 pl-5 max-lg:pt-5">
            ...
            <div className="my-2 pb-10 text-4xl max-xl:pb-5">
